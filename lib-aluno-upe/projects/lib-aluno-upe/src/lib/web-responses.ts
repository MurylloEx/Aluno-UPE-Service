export const WebResponses = {
    ...
    API_CREATESUBJECT_STATUS: {
        UPE_RESPONSE_API_CREATESUBJECT_INVALIDTOKEN: "UPE_RESPONSE_API_CREATESUBJECT_INVALIDTOKEN",
        UPE_RESPONSE_API_CREATESUBJECT_MISSINGPARAMETERS: "UPE_RESPONSE_API_CREATESUBJECT_MISSINGPARAMETERS",
        UPE_RESPONSE_API_CREATESUBJECT_INVALIDCOURSEID: "UPE_RESPONSE_API_CREATESUBJECT_INVALIDCOURSEID",
        UPE_RESPONSE_API_CREATESUBJECT_FAILED: "UPE_RESPONSE_API_CREATESUBJECT_FAILED",
        UPE_RESPONSE_API_CREATESUBJECT_INVALIDSUBJECTNAME: "UPE_RESPONSE_API_CREATESUBJECT_INVALIDSUBJECTNAME",
        UPE_RESPONSE_API_CREATESUBJECT_SUCCESSFULLY: "UPE_RESPONSE_API_CREATESUBJECT_SUCCESSFULLY"
    },

    API_DELETESUBJECT_STATUS: {
        UPE_RESPONSE_API_DELETESUBJECT_INVALIDTOKEN: "UPE_RESPONSE_API_DELETESUBJECT_INVALIDTOKEN",
        UPE_RESPONSE_API_DELETESUBJECT_INVALIDCOURSEID: "UPE_RESPONSE_API_DELETESUBJECT_INVALIDCOURSEID",
        UPE_RESPONSE_API_DELETESUBJECT_INVALIDSUBJECTID: "UPE_RESPONSE_API_DELETESUBJECT_INVALIDSUBJECTID",
        UPE_RESPONSE_API_DELETESUBJECT_FAILED: "UPE_RESPONSE_API_DELETESUBJECT_FAILED",
        UPE_RESPONSE_API_DELETESUBJECT_SUCCESSFULLY: "UPE_RESPONSE_API_DELETESUBJECT_SUCCESSFULLY"
    },

    API_CREATELOCAL_STATUS: {
        UPE_RESPONSE_API_CREATELOCAL_INVALIDTOKEN: "UPE_RESPONSE_API_CREATELOCAL_INVALIDTOKEN", 
        UPE_RESPONSE_API_CREATELOCAL_INVALIDNAME: "UPE_RESPONSE_API_CREATELOCAL_INVALIDNAME", 
        UPE_RESPONSE_API_CREATELOCAL_INVALIDDESCRIPTION: "UPE_RESPONSE_API_CREATELOCAL_INVALIDDESCRIPTION", 
        UPE_RESPONSE_API_CREATELOCAL_INVALIDCAPACITY: "UPE_RESPONSE_API_CREATELOCAL_INVALIDCAPACITY", 
        UPE_RESPONSE_API_CREATELOCAL_INVALIDBLOCK: "UPE_RESPONSE_API_CREATELOCAL_INVALIDBLOCK", 
        UPE_RESPONSE_API_CREATELOCAL_INVALIDFLOOR: "UPE_RESPONSE_API_CREATELOCAL_INVALIDFLOOR", 
        UPE_RESPONSE_API_CREATELOCAL_MISSINGPARAMETERS: "UPE_RESPONSE_API_CREATELOCAL_MISSINGPARAMETERS", 
        UPE_RESPONSE_API_CREATELOCAL_FAILED: "UPE_RESPONSE_API_CREATELOCAL_FAILED", 
        UPE_RESPONSE_API_CREATELOCAL_SUCCESSFULLY: "UPE_RESPONSE_API_CREATELOCAL_SUCCESSFULLY"
    },
};
